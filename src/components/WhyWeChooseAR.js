...
import Image from "../Images/whyAR.png"

function WhyWeChooseAR() {
  return (
    <div className="whyAR-container" style={{ backgroundImage:`url(${cloud4})`}}>
        <div>
            <img className='whyAR-image' src={Image}/>
        </div>
            ...
            <div className='outer-container'>
                <div className='inner-container'>
                    <div className='top'>
                        ...
                        <div className='sub-heading'>Student engagement and interest</div>
                    </div>
